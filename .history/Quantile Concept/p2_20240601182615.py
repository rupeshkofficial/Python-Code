...
DESTINATION_CHANNEL_ID = '@destination_channel_username'  # Replace with the actual username of your destination channel

# Initialize the Telegram client with bot token
client = TelegramClient('session_name', API_ID, API_HASH).start(bot_token=TELEGRAM_BOT_TOKEN)
...
async def forward_message_to_channel(event):
    ...
    if 'your keyword' in message:  # Replace 'your keyword' with the actual keyword
